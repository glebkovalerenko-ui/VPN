...
class Settings(BaseSettings):
    ...
    EXPORT_MAX_LATENCY_MS: int = Field(default=3200, ge=1)
    EXPORT_MAX_FIRST_BYTE_MS: int = Field(default=2400, ge=1)
    EXPORT_MIN_DOWNLOAD_MBPS: float = Field(default=2.0, ge=0)
    EXPORT_REQUIRE_SPEED_MEASUREMENT: bool = True
    EXPORT_ALLOW_LEGACY_SPEED_IF_OTHER_SIGNALS_STRONG: bool = False
    EXPORT_REQUIRE_LATEST_CHECK_SUCCESS: bool = True
    EXPORT_MAX_LATEST_CHECK_AGE_MINUTES: int = Field(default=75, ge=1)
    EXPORT_REQUIRE_LAST_TWO_SUCCESSES: bool = False
    EXPORT_REQUIRE_CONSECUTIVE_SUCCESSES: bool = True
    EXPORT_MIN_CONSECUTIVE_SUCCESSES: int = Field(default=1, ge=1)
    EXPORT_RECENT_CHECKS_WINDOW: int = Field(default=5, ge=2)
    EXPORT_MIN_RECENT_SUCCESS_RATIO: float = Field(default=0.75, ge=0, le=1)
    EXPORT_MIN_USER_TARGET_SUCCESS_RATIO: float = Field(default=0.80, ge=0, le=1)
    EXPORT_REQUIRE_CRITICAL_TARGETS_ALL_SUCCESS: bool = False
    EXPORT_MIN_CRITICAL_TARGET_SUCCESS_RATIO: float = Field(default=0.50, ge=0, le=1)
    ...
    def safe_summary(self) -> dict[str, str | int | float | bool]:
        ...
        return {
            ...
            "EXPORT_ALLOW_LEGACY_SPEED_IF_OTHER_SIGNALS_STRONG": self.EXPORT_ALLOW_LEGACY_SPEED_IF_OTHER_SIGNALS_STRONG,
            ...
            "EXPORT_REQUIRE_CONSECUTIVE_SUCCESSES": self.EXPORT_REQUIRE_CONSECUTIVE_SUCCESSES,
            "EXPORT_MIN_CONSECUTIVE_SUCCESSES": self.EXPORT_MIN_CONSECUTIVE_SUCCESSES,
